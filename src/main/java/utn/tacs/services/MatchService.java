...
public class MatchService {
    ...
    public ListMatchModelResponse findAll(MatchPagingRequest req) throws PaginationException {
        final List<Match> matches = matchesRepository.findAll(new Page(req.getOffSet(), req.getLimit()));
